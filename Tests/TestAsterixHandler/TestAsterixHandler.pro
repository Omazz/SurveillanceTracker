...
TARGET = TestAsterixHandler

DESTDIR = ../../ProgramBuilds/TEST-AsterixHandler

OBJECTS_DIR = ../../ProgramBuilds/TEST-AsterixHandler

MOC_DIR = ../../ProgramBuilds/TEST-AsterixHandler

UI_DIR = ../../ProgramBuilds/TEST-AsterixHandler
