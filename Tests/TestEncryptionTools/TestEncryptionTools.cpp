...
TestEncryptionTools::TestEncryptionTools(QObject *parent)
    : QObject{parent}
{

}

void TestEncryptionTools::encrypt_encryptingSimpleMessage() {
...
void TestEncryptionTools::decrypt_decryptingSimpleMessage() {
    ByteBlock key = hex_to_bytes("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    ByteBlock iv = hex_to_bytes("abcdef12345600dacdef94756eeabefa");
...
void TestEncryptionTools::encrypt_streamingEncryption() {
    ByteBlock key = hex_to_bytes("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    ByteBlock iv = hex_to_bytes("abcdef12345600dacdef94756eeabefa");
...
void TestEncryptionTools::hash_exampleFromStandart256() {
    unsigned char m[] = {
...
void TestEncryptionTools::hash_exampleFromStandart512() {
    unsigned char m[] = {
        0x32, 0x31, 0x30, 0x39, 0x38, 0x37, 0x36, 0x35, 0x34, 0x33, 0x32, 0x31, 0x30, 0x39, 0x38, 0x37,
        0x36, 0x35, 0x34, 0x33, 0x32, 0x31, 0x30, 0x39, 0x38, 0x37, 0x36, 0x35, 0x34, 0x33, 0x32, 0x31,
        0x30, 0x39, 0x38, 0x37, 0x36, 0x35, 0x34, 0x33, 0x32, 0x31, 0x30, 0x39, 0x38, 0x37, 0x36, 0x35,
...
void TestEncryptionTools::hash_exampleWorkCipherWithMAC_attackerHasBeenDetected() {
    ByteBlock key = hex_to_bytes("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    ByteBlock iv = hex_to_bytes("abcdef12345600dacdef94756eeabefa");
