...
Test_Matrix::Test_Matrix(QObject *parent)
    : QObject{parent}
{
...
void Test_Matrix:: sum_calculateSumMatrices() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: difference_calculateDifferenceMatrices() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: multiply_calculateMultiplyMatrices() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: transpose_calculateTransposeMatrix() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: calculateDeterminant_calculateDeterminantMatrix() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: calculateInverseMatrix_calculateInverseMatrix() {
    Matrix a(2, 2);
    a.set(0, 0, 1);
    a.set(1, 0, 2);
    a.set(1, 1, 3);
...
void Test_Matrix:: calculateAlgebraicAdjunct_calculateAlgebraicAdjunctMatrix() {
    Matrix a(3, 3);
    a.set(0, 0, 1);
    a.set(0, 1, 2);
    a.set(0, 2, 3);
