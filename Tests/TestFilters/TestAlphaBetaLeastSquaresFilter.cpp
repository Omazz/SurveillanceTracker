...
TestAlphaBetaLeastSquaresFilter::TestAlphaBetaLeastSquaresFilter(QObject *parent)
    : QObject{parent}
{

}

void TestAlphaBetaLeastSquaresFilter::filterTrack_linearWithoutNoise() {
    ...
    AlphaBetaLeastSquaresFilter filter(15, 5);
...
void TestAlphaBetaLeastSquaresFilter::filterTrack_linearWithNoise() {
